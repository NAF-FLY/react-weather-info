  ...
  const items = [
    {
      icon_id: 'temp',
      name: 'Температура',
      value: `${Math.round(weatherItem.main.temp)}° - ощущается как ${Math.round(weatherItem.main.feels_like)}°`,
    },
    {
      icon_id: 'pressure',
      name: 'Давление',
      value: `${Math.round(weatherItem.main.pressure*0.75)} мм ртутного столба - нормальное`,
    },
    {
